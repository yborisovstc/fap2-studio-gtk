...
class ElemCompRp: public Gtk::Layout
{
	...
	// Helpers
	static void GetFormattedContent(MElem* aElem, string& aContent);
	static void GetContentFormatted(MElem* aElem, const string& aContName, TInt aIndent, string& aRes);
    protected:
	MElem* iElem;
	ElemCompHead* iHead;
